...
for storing large, chunked n-dimensional arrays and arbitrary metadata. The N5 API and documentation typically refer to arrays as
"datasets", [terminology inherited from HDF5](https://docs.hdfgroup.org/hdf5/develop/_g_l_s.html#title3) that we will use in this tutorial.
We will learn about:

* creating readers and writers
* modifying and inspecting the hierarchy ("folder structure")
* saving and loading datasets (arrays)
* saving and loading metadata

## Readers and writers

[`N5Reader`](https://github.com/saalfeldlab/n5/blob/3.1.2/src/main/java/org/janelia/saalfeldlab/n5/N5Reader.java)s and 
